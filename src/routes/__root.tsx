...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LDD · Lumi &amp; Dee-Dee — Anti-minimalist merch & branded gear" },
      ...
      { property: "og:title", content: "LDD · Lumi &amp; Dee-Dee — Anti-minimalist merch & branded gear" },
      ...
      { name: "twitter:title", content: "LDD · Lumi &amp; Dee-Dee — Anti-minimalist merch & branded gear" },
