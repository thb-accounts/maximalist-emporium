...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "LDD · Loud Design Depot — Anti-minimalist merch & branded gear" },
      { property: "og:description", content: "Loud Design Depot prints maximalist branded merch across 20+ categories: tees, hoodies, drinkware, packaging, eco gifts and more." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "LDD · Loud Design Depot — Anti-minimalist merch & branded gear" },
      { name: "twitter:description", content: "Loud Design Depot prints maximalist branded merch across 20+ categories: tees, hoodies, drinkware, packaging, eco gifts and more." },
