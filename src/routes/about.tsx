  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="mx-auto max-w-[1000px] w-full px-4 md:px-8 py-16 space-y-6 font-serif-d text-2xl flex-1">
        <p>Lumi & Dee-Dee is named after our two cats, <strong>Lumi</strong> and <strong>Dee-Dee</strong> — a merch printer for brands, teams, and creators that don't believe in restraint.</p>
