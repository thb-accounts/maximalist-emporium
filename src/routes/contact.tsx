    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="mx-auto max-w-[1200px] w-full px-4 md:px-8 py-16 flex-1 grid md:grid-cols-2 gap-10">
        <div>
          ...
          <h1 className="font-display text-6xl md:text-7xl uppercase leading-[0.9]">Hit us <span className="text-hot">meow.</span></h1>
          <div className="mt-8 space-y-3 font-mono-d text-sm uppercase tracking-widest">
            <div className="brutal-border p-4 bg-acid">ldd@unrealcake8.site</div>
            <div className="brutal-border p-4 bg-electric text-cream">+1 (531) 263-2983 or +1 (518) 479-3482</div>
            <div className="brutal-border p-4 bg-cream">LDD — Worldwide!</div>
          </div>
        </div>
        <form className="brutal-border brutal-shadow-hot bg-cream p-6 space-y-4">
          ...
          <button type="button" className="w-full bg-ink text-cream font-display uppercase py-3 brutal-border hover:bg-hot">Send it meow.</button>
        </form>
      </section>
      <Footer />
    </div>
